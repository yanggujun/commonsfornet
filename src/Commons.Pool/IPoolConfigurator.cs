...
{
    public interface IPoolConfigurator<T> where T : class
    {
        /// <summary>
        ...
        void CreateWith(Func<T> creator);
        ...
        void DestroyWith(Action<T> destroyer);
        ...
        void ByFactory(IPooledObjectFactory<T> factory);
        ...
        /// <returns>The pool descriptor with updated factory.</returns>
        void ValidateWith(IPooledObjectValidator<T> validator);
