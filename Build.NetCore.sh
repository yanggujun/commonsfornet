...
dotnet test src/Test.Commons -f netcoreapp1.0 -o "$OUTPUT/netcoreapp1.0" --no-build
%USERPROFILE%/.nuget/packages/xunit.runner.console/2.1.0/tools/xunit.console.exe $OUTPUT/net40/Test.Commons.dll
%USERPROFILE%/.nuget/packages/xunit.runner.console/2.1.0/tools/xunit.console.exe $OUTPUT/net45/Test.Commons.dll

dotnet run ./src/.nuget/nuget.exe pack Commons.nuspec -outputdirectory $OUTPUT
dotnet run ./src/.nuget/nuget.exe pack Commons.Json.nuspec -outputdirectory $OUTPUT
dotnet run ./src/.nuget/nuget.exe pack Commons.Pool.nuspec -outputdirectory $OUTPUT
